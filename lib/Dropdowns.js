      ...
      <div className="absolute w-80 right-6 z-20  py-2 mt-2 overflow-hidden origin-top-right bg-white rounded-md shadow-xl dark:bg-gray-800">
        ...
        <hr className="border-gray-200 dark:border-gray-700 " />
        {
          dropdown.map((item, index) => {
            return (
              <div key={index} className="flex items-center cursor-pointer p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">

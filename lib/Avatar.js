...
export default function Avatar({ imageURL, userId, width, height, disable , }) {
  ...
  <div className="cursor-pointer inline-block relative">
    <Image src="https://readymadeui.com/team-4.webp" width={ width ? width : 60} height={height ? height : 60} className="rounded-full border-2 border-blue-600 p-0.5" alt="profile" />
    {
      !disable &&

...
export default function page() {
  return (
    <div className="flex flex-col justify-center bg-white font-[sans-serif] sm:h-screen p-4">
  <div className="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8">
    ...
    <form>
      ...
      <div className="!mt-12">
      <button type="button" class="w-full py-3 px-4 text-sm tracking-wider font-semibold rounded-md text-white bg-blue focus:outline-none">
              Create an account
            </button>
      </div>
